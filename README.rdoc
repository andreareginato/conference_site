...
Use the {issue tracker}[http://github.com/andreareginato/rubyday_site/issues] for any bug you find and write 
us a {mail}[mailto:dev@rubyday.com] or a {tweet}[http://twitter.com/rubydayit] for any feature or idea 
...
* {GIT Repository}[git://github.com/andreareginato/rubyday_site.git]
